/*
	...
	The implementation of properties and methods for the HDTagDataSearchResult object.
	Generated by SudzC.com
*/
#import "HDTagDataSearchResult.h"

#import "HDTagDataArray.h"
@implementation HDTagDataSearchResult
	...
	- (id) init
	{
		if(self = [super init])
		{
			self.results = nil; // [[HDTagDataArray alloc] init];
	...
	+ (HDTagDataSearchResult*) newWithNode: (CXMLNode*) node
	{
		...
		return (HDTagDataSearchResult*)[[[HDTagDataSearchResult alloc] initWithNode: node] autorelease];
	}

	- (id) initWithNode: (CXMLNode*) node {
		if(self = [super initWithNode: node])
		{
			self.results = [[HDTagDataArray newWithNode: [Soap getNode: node withName: @"results"]] object];
	...
	{
		return [self serialize: @"TagDataSearchResult"];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[HDTagDataSearchResult class]]) {
